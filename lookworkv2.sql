...
INSERT INTO `lamaran` (`id_lamaran`, `id_pekerjaan`, `id_pencari_kerja`, `status`, `deskripsi`, `tanggal_lamaran`) VALUES
...
(4, 'Daven Al Khalwarizmmy', 'davenalk216@gmail.com', '$2y$10$jSso09vkB0eCdGlhQT2RpOB9NFJjIZv3ku7O0z3LhBkE12Lq.j7z.', 'pencari_kerja', NULL, '2024-11-13 08:58:28', '', '', '2024-11-13 08:58:28', 'daven');
...
INSERT INTO `perusahaan` (`id_perusahaan`, `id_pengguna`, `nama_perusahaan`, `lokasi_perusahaan`, `industri`, `deskripsi_perusahaan`) VALUES
...
--
ALTER TABLE `pencari_kerja`
  MODIFY `id_pencari_kerja` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
