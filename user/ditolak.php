...
<div class="sidebar">
    ...
    <br><br>
        <button onclick="window.location.href='proses.php'" class="button-link">Proses</button>
        <button onclick="window.location.href='diterima.php'" class="button-link diterima">Diterima</button>
        <button onclick="window.location.href='ditolak.php'" class="button-link ditolak">Ditolak</button>
    </div>
</div>
