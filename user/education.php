...
<body>
    <div class="container-xxl bg-white p-0">
       ...
       <h1 class="m-0" style="color: #16423C;">LookWork</h1>
        ...
        <h2 class="mt-5">Daftar Pendidikan</h2>
            ...
            <tbody>
                ...
                <tr>
                    <form action="process.php" method="POST">
                        ...
                        <td><input type="text" name="institusi" value="<?= htmlspecialchars($row['institusi']); ?>" class="form-control"></td>
                        <td><input type="text" name="gelar" value="<?= htmlspecialchars($row['gelar']); ?>" class="form-control"></td>
                        <td><input type="text" name="bidang_studi" value="<?= htmlspecialchars($row['bidang_studi']); ?>" class="form-control"></td>
                        <td><input type="number" name="tahun_mulai" value="<?= $row['tahun_mulai']; ?>" class="form-control"></td>
                        <td><input type="number" name="tahun_selesai" value="<?= $row['tahun_selesai']; ?>" class="form-control"></td>
                        <td>
                            <button type="submit" class="btn btn-warning">Update</button>
                            <a href="process.php?action=delete_education&id_pendidikan=<?= $row['id_pendidikan']; ?>" class="btn btn-danger">Hapus</a>
                        </td>
                    </form>
                </tr>
                <?php endwhile; ?>
